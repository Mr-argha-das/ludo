...
import 'package:ludo/gameingane/widgets/pawn_widget.dart';
...
class BoardWidget extends StatefulWidget {
  Function callBack;
  bool playersTrueFalse;
  BoardWidget(
      {super.key, required this.callBack, required this.playersTrueFalse});
...
class _BoardWidgetState extends State<BoardWidget> {
  ...
  void initState() {
    ...
    super.initState();
    log(PlayerChose.player.toString());
  }
    ...
    return Container(
      ...
      child: Consumer<LudoProvider>(
        builder: (context, value, child) {
          ...
          log(value.currentPlayer.type.toString());
