...
class LudoGameEngineMainScreen extends StatefulWidget {
  const LudoGameEngineMainScreen({super.key});

  @override
  State<LudoGameEngineMainScreen> createState() =>
      _LudoGameEngineMainScreenState();
}

class _LudoGameEngineMainScreenState extends State<LudoGameEngineMainScreen> {
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  if (myData.value == LudoPlayerType.red) ...[
                                    Padding(
                                      padding: const EdgeInsets.only(left: 10),
                                      child: Container(
                                        height: 85,
