                        ...
                        children: [
                          GestureDetector(
                              onTap: () async {
                                ...
                                //   await LudoPhonelogin.sendOtp(context,
                                //       number: controller.text,
                                //       iscode: codeCountry, callBack: () {
                                //     lodar = false;
                                //   }, mobileno: controller.text);
                                // }
                                final signupService =
                                    UserLoginSignup(createDio());
                                final loginService = UserLogin(createDio());
                                try {
                                  SignUpResponse response = await signupService
                                      .signupp(UserCreateModel(
                                          enloginid:
                                  ...
                                  await prefs.setString('userId',
                                      response.data!.id.oid.toString());

                                  await prefs.setString('enloginid',
                                      response.data!.enloginid.toString());
                                  ...
                                  await prefs.setString('userId',
                                      loginUpResponse.data.id.oid.toString());

                                  await prefs.setString(
                                      'enloginid',
                                      loginUpResponse.data.enloginid
                                          .toString());
...
GestureDetector gooleLoginButton(context, Function callBack) {
  return GestureDetector(
    onTap: () async {
      ...
      //     Map<String, dynamic> userDataGoogle =
      //         jsonDecode(data.additionalUserInfo!.profile.toString());
